...
public class OAuthApi {
	...
	public static String getCodeUrl(String redirectUri,String state){
		String getCodeUrl="https://open.weixin.qq.com/connect/oauth2/authorize?appid=CORPID&redirect_uri=REDIRECT_URI&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect";
	...
	public static ApiResult getUserInfoByCode(String code){
		String getUserInfoUrl="https://qyapi.weixin.qq.com/cgi-bin/user/getuserinfo?access_token=ACCESS_TOKEN&code=CODE";
	...
	public static ApiResult ToOpenId(String data){
		 String toOpenIdUrl="https://qyapi.weixin.qq.com/cgi-bin/user/convert_to_openid?access_token=ACCESS_TOKEN";
	...
	public static ApiResult ToUserId(String data){
		  String toUserIdUrl="https://qyapi.weixin.qq.com/cgi-bin/user/convert_to_userid?access_token=ACCESS_TOKEN";
