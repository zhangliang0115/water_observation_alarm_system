...
public class QyWeixinMsgController extends MsgController {
	...
	public ApiConfig getApiConfig() {
		 ...
		 *  目前企业号只支持加密且必须配置
		 */
		ac.setEncryptMessage(PropKit.getProp("wx_config.properties").getBoolean("encryptMessage", true));
		ac.setEncodingAesKey(PropKit.getProp("wx_config.properties").get("encodingAesKey", "setting it in config file"));
		return ac;
	}
